...
const PorductInfo = ({route,navigation}) => {
        ...
        <View style={{
          ...
          <View style={{
            ...
            <View style={{
              ...
              <Text style={{color:COLOURS.black}}>Alameda Franklin Delano Roosevelt, San Salvador</Text>
            </View>
          ...
          <View style={{
            ...
            <Text style={{color:COLOURS.black}}>
              Descuento del 10% ~ &#36; {product.productPrice/10} (&#36; {product.productPrice - product.productPrice/10})
            </Text>
          </View>         
        </View>    
      </ScrollView>  
